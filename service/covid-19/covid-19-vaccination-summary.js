...
const getPatientVaccinationSummary = (patientUuid) => {
  return new Promise((resolve, reject) => {
    ...
    CASE
        WHEN c.covid_screening_outcome_this_visit = 703 THEN 'POSITIVE'
        WHEN c.covid_screening_outcome_this_visit = 664 THEN 'NEGATIVE'
        WHEN c.covid_screening_outcome_this_visit = 1067 THEN 'UNKNOWN'
        ELSE ''
